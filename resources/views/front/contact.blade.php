...
@section('content')
   <!-- 〽️ Start Header Section 〽️ -->
   <header class="global-heade-other-pages articles-details-hero-content">
    <img
      src="{{ asset('front') }}/images/global/landscapping-work-شركة-بستاني-الأفضل-فى-تنسيق-الحدائق-و-البساتين-تنسيق-حدائق-كافر-صفحات-الموقع.jpg"
      alt="hero"
      class="header-hero-style"
    />
    <div class="container">
      <div class="row">
        <div class="here-content">
          <h1>نصائح للحصول على حديقة خلابة بتكلفة معقولة</h1>
          <p>
            شركة بستاني الأفضل فى تصميم وتنسيق الحدائق بالمملكة العربية
            السعودية
          </p>
        </div>
      </div>
  ...
  <section class="container">
    <div class="contact-us-section">
      <img
        ...
        width="800"
        height="600"
        src="{{ isset($setting) && $setting->contact_image != null ? asset('uploads/about/'.$setting->contact_image) : asset('front/images/global/landscapping-work-شركة-بستاني-الأفضل-فى-تنسيق-الحدائق-و-البساتين-تنسيق-حدائق-كافر-صفحات-الموقع-تواصل-مع-الشركة.jpg') }}"
        class="attachment-full size-full wp-image-1097"
        alt=""
        srcset=""
      ...
      <div class="contact-us-info">
        ...
        <ul>
          <li class="icon-list-item">
            ...
            <span class="icon-list-text">{{$setting->phone}}</span>
          </li>
          <li class="icon-list-item">
            <span class="icon-list-icon">
            ...
            <span class="icon-list-text"
              >{{ $setting->getTranslation('address', 'ar') }}</span
            >
          </li>
        </ul>
        ...
        <div class="contact-social">
          <div class="social">
            ...
            <a href="{{$setting->facebook}}" alt="bostany facebook">
              <i style="color: #fff !important" class="fab fa-facebook"></i>
            </a>
            @endif
            @if ($setting->insta)

            <a href="{{$setting->insta}}" alt="bostany insta">
              <i
            ...
            <a href="{{$setting->youtube}}" alt="bostany youtube">
              <i style="color: #fff !important" class="fab fa-youtube"></i>
            </a>
            @endif
            @if ($setting->twitter)

            <a href="{{$setting->twitter}}" alt="bostany twitter">
              <i style="color: #fff !important" class="fab fa-twitter"></i>
            </a>
            @endif
  ...
  <!-- 〽️ Start Request our services  〽️ -->
  <section class="request-our-services">
    <div class="container">
      <div class="requset-content">
        <h2>
          شركة بستاني تقدم أفضل خدمات تصميم وتنسيق الحدائق والديكورات في
          مدينة الرياض بالمملكة العربية السعودية.
        </h2>
        <hr style="height: 2px; color: #8dc100; width: 3rem; opacity: 1" />

        <p>
            {{ $model7->description }}
        </p>
        <a class="sm" href="https://wa.me/{{$setting->phone}}">
          <div class="phone-button-div">
            <span class="phone-button-text">اطلب خدماتنا الآن</span>
          </div>
        </a>
      </div>
    </div>
  </section>
  <!-- 〽️ End Request our services  〽️ -->

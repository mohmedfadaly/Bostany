        ...
        <div class="post-card">
            <a href="{{ route('article.front', $value?->id) }}">
              <div class="articles-image">
                <img
                  ...
                  class="attachment-full size-full wp-image-1117"
                  alt="articles-image"
                  srcset="\"
            ...
            <div class="post-card__description">
              <div class="post__avatar">
                <img
                  alt="admin"
                  src="{{asset('uploads/news/avatar/'.$data->avatar)}}"
                  srcset=""
              ...
              <div>
                <a href="{{ route('article.front', $value?->id) }}"> {{$value->title}}</a>
              </div>
              <p>
                  {!! Str::limit(strip_tags($value->content), 50, '.......') !!}
              </p>
              <a href="{{ route('article.front', $value?->id) }}" class="showmore"> قراءة المزيد » </a>
            </div>
          </div>
        @endforeach

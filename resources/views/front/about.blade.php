...
<header class="global-heade-other-pages articles-details-hero-content">
    ...
    <section class="about-company-image">
        <img
          fetchpriority="high"
          decoding="async"
          width="960"
          height="350"
          src="{{ isset($about) && $about->image1 != null ? asset('uploads/about1/'.$about->image1) : asset('front/images/global/landscapping-work-شركة-بستاني-الأفضل-فى-تنسيق-الحدائق-و-البساتين-تنسيق-حدائق.jpg')}}"
          class="attachment-full size-full wp-image-1050"
          alt=""
          srcset=""
        ...
        <img
          ...
          width="960"
          height="350"
          src="{{ isset($about) && $about->image2 != null ? asset('uploads/about2/'.$about->image2) : asset('front/images/global/about-us-02.jpg')}}"
          class="attachment-full size-full wp-image-517"
          alt=""
          srcset=""
          sizes="(max-width: 960px) 100vw, 960px"
        />
      </section>
      <!-- 〽️ End about-company-image 〽️ -->

...
@section('content')
      ...
      <!-- 〽️ Start Articles Details 〽️  -->
      <section class="container">
        <div class="articles-section-page">
          <img
            loading="lazy"
            width="750"
            height="500"
            src="{{asset('uploads/news/cover'.$modal->cover)}}"
            class="attachment-full size-full wp-image-1149"
            alt=""
            srcset=""
          ...
          <div class="share-articles">
            <h5>شارك هذه المقالة مع الأصدقاء و العائلة علي السوشيال ميديا</h5>

            <div class="social-container">
              <div class="social">
                <a href="https://www.facebook.com/sharer/sharer.php?u={{url()->current()}}" alt="bostany facebook">
                  <i style="color: #fff !important" class="fab fa-facebook"></i>
                </a>
                <a href="https://www.instagram.com/?url={{url()->current()}}" alt="bostany insta">
                  <i
                    style="color: #fff !important"
                    class="fab fa-instagram"
                  ></i>
                </a>
                <a href="https://twitter.com/intent/tweet?url={{url()->current()}}" alt="bostany twitter">
          ...
          <div class="show-more-articles-swiper">
            <h5>مزيد من المقالات المفيدة فى تنسيق الحدائق و البساتين</h5>

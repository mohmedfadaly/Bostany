...
<header>
    <img src="{{ isset($model1) && $model1->image != null ? asset('uploads/main/'.$model1->image) : asset('front/images/hero/hero.webp') }}" alt="hero" class="header-hero-style" />
    <div class="container">
        <div class="row">
            <div class="here-content">
                <h5>{{$model1->title_color}}</h5>
                <h1>
                    {{$model1->title}}
                </h1>
                <p>
                ...
                <a href="https://wa.me/{{$setting->phone}}" target="_blank">
                    ...
                    <span class="span-text">تواصل معنا علي {{$setting->phone}}</span>
                </a>
            </div>
        </div>
    </div>

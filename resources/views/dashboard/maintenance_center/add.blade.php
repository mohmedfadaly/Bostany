...
@section('title', 'اضافة مركز صيانة')
...
<div class="card">
    ...
    <div class="card-content">
        <div class="card-body">
            <form class="form form-vertical" action="{{route('maintenance_center.store')}}" method="POST" enctype="multipart/form-data">
                <div class="form-body">
                    <div class="row">
                        @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" maxlength="190" name="name_en" required id="name_en">
                                    </div>
                                </div>
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" maxlength="190" name="name_ar" required id="name_ar">
                                    </div>
                                </div>
                        ...
                        <div class="col-6">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        <label for="phones"> أرقام الجوال <span class="text-warning">إفصل بين كل رقم بسافة </span></label>
                                        <textarea name="phones" class="form-control" id="phones" cols="10" rows="5" required></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <textarea name="emails" class="form-control" id="emails" cols="10" rows="5"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input name="lng" class="form-control" id="lng" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="address" class="form-control" id="address" cols="10" rows="5" required></textarea>
                                    </div>
                                </div>

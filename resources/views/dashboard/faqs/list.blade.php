            ...
            <table class="table data-list-view">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="product-category">{{ $row->section->title_ar }}</td>
                        <td>
                        ...
                        <td class="product-action">
                            ...
                            <a href="{{ route('faqs.delete',$row->id) }}" class="action-delete"><i class="feather icon-trash"></i></a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
                        ...
                        <form action="" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 data-field-col">
                                  <label for="data-title_ar">القسم</label>
                                  <select name="faqs_section_id" class="form-control" id="">
...
$(document).ready(function() {
    ...
    buttons: [
      {
        ...
        action: function() {
          ...
          $('form').attr('action',"{{route('faqs.store')}}")
  ...
  $(".hide-data-sidebar, .cancel-data-btn, .overlay-bg").on("click", function() {
    ...
    $('.action-edit').on("click",function(e){
      ...
      $('form').attr('action',"{{url('faqs/update')}}"+"/"+data.id)

            ...
            <div class="col-sm-12">
                <div class="row">
                    <div class="col-sm-10 " >
                        ...
                        <input type="text" name="role"  value="{{$role->name}}" class="sqaure form-control" required="">
                    </div>
             ...
             <!-- Vuexy Checkbox Color start -->
                <section class="vuexy-checkbox-color">
                 ...
                 <div class="col-sm-12" style="margin-top:20px;text-align: center;">
                    <button class="btn btn-primary round btn-block update_permission" style="width: 50%;
                    margin-left: auto;
                    margin-right: auto;" type="button">تعديل</button>
                </div>
            </div>
        </div>
    </section>
...
<script type="text/javascript">
    ...
    $('.update_permission').on('click',function(){
        ...
        }else if(role === '')
        {
          ...
          $.post("{{route('roles.update')}}",{_token:"{{csrf_token()}}",id:role_id,ids:ids,role:role},function(data, status){

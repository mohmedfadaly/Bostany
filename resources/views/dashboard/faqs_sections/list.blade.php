...
@section('title', 'أقسام الأسئلة الشائعة')
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="product-action">
                            ...
                            <a href="{{ route('faqs_section.delete',$row->id) }}" class="action-delete _delete"><i class="feather icon-trash _delete"></i></a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
...
$(document).ready(function() {
    ...
    buttons: [
      {
        ...
        action: function() {
          ...
          $('form').attr('action',"{{route('faqs_section.store')}}")
  ...
  $(".hide-data-sidebar, .cancel-data-btn, .overlay-bg").on("click", function() {
    ...
    $('.action-edit').on("click",function(e){
      ...
      $('form').attr('action',"{{url('faqs/sections/update')}}"+"/"+data.id)

...
@section('title', '    شرائط تمرير المركز')
            ...
            <table class="table data-list-view">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><img src="{{ asset('uploads/media/sliders/' . $row->image) }}"
                            alt=""
                            style="width: 70px;"></td>
                        <td>
                        ...
                        <td class="product-action">
                            ...
                            <a href="{{ route('media_sliders.delete',$row->id) }}" class="action-delete _delete"><i class="feather icon-trash _delete"></i></a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 data-field-col">
                                    ...
                                    <img src="{{ asset('app-assets/images/defoult.jpg') }}"
                                        style="display: block;width: 100%;height: 250px;cursor: pointer;"
...
$(document).ready(function() {
    ...
    buttons: [
      {
        ...
        action: function() {
          ...
          $('form').attr('action',"{{route('media_sliders.store')}}")
  ...
  $(".hide-data-sidebar, .cancel-data-btn, .overlay-bg").on("click", function() {
    ...
    $('.action-edit').on("click",function(e){
      ...
      $('form').attr('action',"{{url('admin/media_sliders/update-media-sliders')}}"+"/"+data.id)

      $('.text-uppercase').text('تعديل ' + data.title.ar)
      $('#data-title_ar').val(data.title.ar);
      $('#data-title_en').val(data.title.en);

      var url = "{{ url('uploads/media/sliders') }}/" + data.image
      console.log(url);
            $('#avatar5').attr('src', url);

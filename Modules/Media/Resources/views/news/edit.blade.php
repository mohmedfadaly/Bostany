...
<div class="card">
    ...
    <div class="card-content">
        <div class="card-body">
            <form class="form form-vertical" novalidate action="{{route('news.update',$data->id)}}" method="POST" enctype="multipart/form-data">
                <div class="form-body">
                    <div class="row">
                        @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-2">
                                    ...
                                    <input type="file" name="cover"
                                        accept="image/*" onchange="loadAvatar5(event)"
                                        style="display: none;">
                                    <img src="{{asset('uploads/news/cover/'.$data->cover)}}"
                                        style="display: block;width: 100%;height: 100px;cursor: pointer;"
                                        onclick="ChooseAvatar5()" id="avatar5">
                                </div>
                                <div class="col-sm-2">
                                    ...
                                    <input type="file" name="avatar"
                                        ...
                                        style="display: none;">
                                    <img src="{{asset('uploads/news/avatar/'.$data->avatar)}}"
                                        style="display: block;width: 100%;height: 100px;cursor: pointer;"
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="name" class="form-control" value="{{ $data->title }}" placeholder=" العنوان" name="title">
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="sub_title" value="{{ $data->sub_title }}"  class="form-control" placeholder=" العنوان الجانبي" name="sub_title">
                                            </div>
                                        </div>
                                ...
                                <div class="col-12 d-flex "  style="margin-top: 30px">
                                    <textarea class="form-control" name="content"  id="full-featured-non-premium"  rows="4" cols="6"> {!! $data->content !!}</textarea>

                                </div>


                                <button class="btn btn-primary store" type="submit" style="margin-right: 20px;margin-top:30px">تعديل مقال

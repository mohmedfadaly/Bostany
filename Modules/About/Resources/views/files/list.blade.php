                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="product-action">
                            ...
                            <a href="{{ route('files.delete',$row->id) }}" class="action-delete _delete"><i class="feather icon-trash _delete"></i></a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
                    ...
                    <div class="data-fields px-2 mt-3">
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 data-field-col">
                                    <label for="data-date"> الملف</label>
                                    <input type="file" class="form-control" name="file" id="data-date" maxlength="190" required>
                                </div>
...
$(document).ready(function() {
    ...
    buttons: [
      {
        ...
        action: function() {
          ...
          $('form').attr('action',"{{route('files.store')}}")
  ...
  $(".hide-data-sidebar, .cancel-data-btn, .overlay-bg").on("click", function() {
    ...
    $('.action-edit').on("click",function(e){
      ...
      $('form').attr('action',"{{url('admin/files/update')}}"+"/"+data.id)
